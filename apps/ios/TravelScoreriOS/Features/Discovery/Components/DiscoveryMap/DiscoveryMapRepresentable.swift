//
//  DiscoveryMapRepresentable.swift
//  TravelScoreriOS
//
...
struct DiscoveryMapRepresentable: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> MKMapView {
        ...
        let tapGesture = UITapGestureRecognizer(
            ...
            action: #selector(DiscoveryMapCoordinator.handleTap(_:))
        )
    ...
    func makeCoordinator() -> DiscoveryMapCoordinator {
        let coordinator = DiscoveryMapCoordinator(
            countries: countries,
...
private extension DiscoveryMapRepresentable {
